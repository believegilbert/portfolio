const Work = () => {
  return (
    <div
    id="work"
    className="overflow-x-hidden w-[100%] flex flex-col items-center justify-center  mt-[4.5rem] sm:mt-[3.5rem]">
      <h1 className="select-none text-center text-[#1289eb] font-medium sm:font-bold text-[1.3rem] sm:text-[1.9rem] underline underline-offset-4 mb-[1rem] md:mb-[2rem]">
        Work
      </h1>
      <p className="text-sm sm:mt-5 text-gray-400 italic mb-2 text-[1rem] sm:text-[1.2rem] text-center w-[80%]">
        *Note: Backend project demos focus more on functionality than user
        interface. They may not be as visually interactive as frontend projects.
      </p>
        ...
        <div className="space-y-4 md:grid md:grid-cols-2 grid-rows-3 md:gap-10 w-[85%] md:w-[90%] sm:w-[90%] max-w-[1600px] mx-auto">
          <div>
            ...
            <span className="text-xs sm:text-[1.2rem] text-gray-500 italic font-medium">
              <span className="font-bold"> Text-based AI chat</span> — Vuejs,
          ...
          <div className="mb-[1.1rem] md:mb-0">
            ...
            <span className="text-xs sm:text-[1.2rem] text-gray-500 italic font-medium">
              <span className="font-bold">Mini Blog API (Backend)</span> —
          ...
          <div>
            ...
            <span className="text-xs sm:text-[1.2rem] text-gray-500 italic font-medium">
              <span className="font-bold">Student Management System</span> —
              Reactjs, Material UI, Nodejs, Express, MongoDB.
            </span>
          </div>
        </div>
      </div>
