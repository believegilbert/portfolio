const Skills = () => {
  return (
    <div id="skills" className="overflow-x-hidden mt-[3.5rem] sm:mt-[5rem]">
            ...
            <div className="">
              <div className="mb-[1.2rem] sm:mb-[2.2rem]  w-[115%] lg:w-[150%]">
                <div className="flex justify-between mb-1 w-[100%]">
                  <span className="text-sm sm:text-[1rem] font-medium">
                    Frontend
                  </span>
      ...
      <div className="block space-y-3 w-[85%] mx-auto md:w-[70%] lg:w-[80%] lg:flex md:space-x-4 mt-[2rem]">
        <div data-aos="fade-left" data-aos-delay="300" className="flex flex-1">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-6 justify-items-center mt-6 text-sm">
                {[
                  {
                    name: "HTML",
                    src: "https://unpkg.com/simple-icons@v11/icons/html5.svg",
                  },
                  {
                    name: "CSS",
                    src: "https://unpkg.com/simple-icons@v11/icons/css3.svg",
                  },
                  {
                    name: "JavaScript",
                    src: "https://unpkg.com/simple-icons@v11/icons/javascript.svg",
                  },
                  {
                    name: "React",
                  ...
                  {
                    name: "Git",
                    src: "https://unpkg.com/simple-icons@v11/icons/git.svg",
                  },
                ].map((tech) => (
                  <div
                    key={tech.name}
        ...
        <div data-aos="fade-up" data-aos-delay="300" className="flex flex-1">
          <div className="flex flex-1 bg-gray-900 text-gray-300 h-[490px] md:h-[550px] rounded-[3rem] justify-center items-center px-8 py-6">
            <div className="text-center space-y-6">
              <h1 className="text-[1.1rem] sm:text-2xl font-semibold text-gray-300">
                Backend Development
              ...
              <p className="text-gray-400 max-w-md mx-auto text-sm">
                I build fast, scalable, and secure backend services using modern
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-6 justify-items-center mt-6 text-sm">
                {[
                  ...
                  {
                    name: "Express",
                    src: "https://unpkg.com/simple-icons@v11/icons/express.svg",
                  },
                  {
                    name: "MongoDB",
                    src: "https://unpkg.com/simple-icons@v11/icons/mongodb.svg",
                  },
                  {
                    name: "PostgreSQL",
                    src: "https://unpkg.com/simple-icons@v11/icons/postgresql.svg",
                  },
                  {
                    name: "Firebase",
                    src: "https://unpkg.com/simple-icons@v11/icons/firebase.svg",
                  },
                ].map((tech) => (
                  <div
                    key={tech.name}
        ...
        <div data-aos="fade-right" data-aos-delay="300" className="flex flex-1">
          <div className="flex flex-1 bg-gray-900 text-gray-300 h-[490px] md:h-[550px] rounded-[3rem] justify-center items-center px-8 py-6">
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-400 max-w-md mx-auto text-sm">
                Beyond code, I bring strong communication, adaptability, and a
